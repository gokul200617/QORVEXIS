...
from app.connectors.openrouter.openrouter_client import OpenRouterClient
import app.connectors.openrouter.openrouter_normalizer  # noqa: F401

logger = logging.getLogger("qorvexis.connectors.openrouter.connector")
...
class OpenRouterConnector(BaseConnector):
    ...
    def normalize(self, raw_data: dict) -> dict:
        """Map raw OpenRouter telemetry. Real analytics bypass this layer."""
        return {}
    ...
    def disconnect(self) -> None:
        self._client = None
        self._status = ConnectorStatus.DISCONNECTED
        logger.info("openrouter.connector.disconnected id=%s", self.connector_id)
